...
gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_1__.ScrollTrigger.matchMedia({
  "(min-width: 600px)": function minWidth600px() {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from(".portfolio__header", {
      xPercent: -25,
      autoAlpha: 0,
      duration: 1.5,
      scrollTrigger: {
...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".side-dot-nav", {
  xPercent: 100,
  autoAlpha: 1,
  scrollTrigger: {
    trigger: ".portfolio",
...
var cursorBg = document.getElementById("cursor-bg");
var yAxis = 0;
var xAxis = 0;
var cursorSizeClass;
window.addEventListener("mousemove", function (e) {
  ...
  cursor.style.transform = "translate(".concat(xAxis, "px, ").concat(yAxis, "px) translate(-50%, -50%)");
});
