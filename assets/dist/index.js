...
/* harmony import */ var _porfolio_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./porfolio.js */ "./assets/js/porfolio.js");





var bodyScrollBar = smooth_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"].init(document.querySelector("#smooth-scrollbar"), {
  damping: 0.06,
...
gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.scrollerProxy(document.body, {
...
gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger.matchMedia({
  "(min-width: 600px)": function minWidth600px() {
    gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.from(".portfolio__header", {
      xPercent: -25,
      autoAlpha: 0,
      duration: 1.5,
      scrollTrigger: {
...
var sideNavDotHome = document.querySelector(".side-dot-nav__item--home");
var sideNavDotPortfolio = document.querySelector(".side-dot-nav__item--portfolio");
var sideNavDotContact = document.querySelector(".side-dot-nav__item--contact");
sideNavDotContact.addEventListener("click", function () {
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(window, {
    duration: 1.2,
    scrollTo: "#contact"
  });
});
sideNavDotPortfolio.addEventListener("click", function () {
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(window, {
    duration: 1.2,
    scrollTo: "#portfolio"
  });
});
sideNavDotHome.addEventListener("click", function () {
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(window, {
    duration: 1.2,
    scrollTo: 0
  });
});
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(".side-dot-nav", {
  xPercent: 100,
  autoAlpha: 1,
  scrollTrigger: {
    trigger: ".portfolio",
...
items.forEach(function (item) {
  var direction = item.dataset.animDirection;
...
function fromTop(item, tl) {
  var overview = item.querySelector(".overview");
  var cover = item.querySelector(".cover");
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set([overview, cover], {
    yPercent: -100
  });
...
/******/ 	__webpack_require__.O(undefined, ["assets/dist/main"], () => (__webpack_require__("./assets/js/index.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/dist/main"], () => (__webpack_require__("./assets/sass/main.scss")))
